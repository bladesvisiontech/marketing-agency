...
import { CheckCircle, ArrowRight, Search, TrendingUp, Lightbulb, Target } from "lucide-react";
import AnimateIn from "@/components/AnimateIn";
import { getDictionary, isValidLocale } from "@/lib/i18n";
import type { Locale } from "@/lib/i18n";
import type { Metadata } from "next";

const icons = [Search, Target, TrendingUp, Lightbulb];
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const t = dict.services_page.audit;
    ...
    <>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-5 pt-20 pb-16">
          ...
          <AnimateIn delay={180}>
            <div className="flex flex-col sm:flex-row items-start gap-4">
              <a href="https://buy.stripe.com/auditoria800" target="_blank" rel="noopener noreferrer" className="btn-primary text-base px-6 py-3">
      ...
      <section className="section border-t border-white/[0.06]">
        <div className="max-w-4xl mx-auto px-5">
          <AnimateIn className="mb-10"><h2 className="text-3xl font-bold tracking-tight">{t.analyzed_title}</h2></AnimateIn>
          <AnimateIn>
      ...
      <section className="section border-t border-white/[0.06]">
        <div className="max-w-5xl mx-auto px-5">
          <AnimateIn className="mb-10"><h2 className="text-3xl font-bold tracking-tight">{t.deliverables_title}</h2></AnimateIn>
          <AnimateIn stagger>
      ...
      <section className="section border-t border-white/[0.06] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-5 text-center">
          <AnimateIn>
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-3">{t.cta_final_h2}</h2>
            <p className="text-white/60 text-xl mb-1">{t.cta_final_sub2}</p>
            <p className="text-white/30 mb-8">{t.cta_final_body}</p>
            <a href="https://buy.stripe.com/auditoria800" target="_blank" rel="noopener noreferrer" className="btn-primary text-base px-7 py-3.5 inline-flex">
