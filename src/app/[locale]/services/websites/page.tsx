...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const t = dict.services_page.websites;
    ...
    <>
      <section className="relative min-h-[70vh] flex items-center overflow-hidden dot-grid">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-5 pt-20 pb-16">
          ...
          <AnimateIn delay={120}>
            <p className="text-white/50 text-xl mb-8 max-w-xl">{t.subheadline}</p>
          </AnimateIn>
          <AnimateIn delay={180}>
            <div className="flex flex-col sm:flex-row items-start gap-4">
              <a href="https://buy.stripe.com/website700" target="_blank" rel="noopener noreferrer" className="btn-primary text-base px-6 py-3">
      ...
      <section className="section border-t border-white/[0.06]">
        <div className="max-w-4xl mx-auto px-5">
          <AnimateIn className="mb-10"><h2 className="text-3xl font-bold tracking-tight">{t.problems_title}</h2></AnimateIn>
          <AnimateIn stagger>
      ...
      <section className="section border-t border-white/[0.06] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-5 text-center">
          <AnimateIn>
            ...
            <a href="https://buy.stripe.com/website700" target="_blank" rel="noopener noreferrer" className="btn-primary text-base px-7 py-3.5 inline-flex">
