...
import { CheckCircle, ArrowRight, TrendingUp, Zap, Award, Users } from "lucide-react";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const t = dict.services_page.seo;
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-5 pt-20 pb-16">
          ...
          <AnimateIn delay={180}>
            <div className="flex flex-col sm:flex-row items-start gap-4">
              <a href="https://buy.stripe.com/seo500" target="_blank" rel="noopener noreferrer" className="btn-primary text-base px-6 py-3">
      ...
      <section className="section border-t border-white/[0.06] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-5 text-center">
          <AnimateIn>
            ...
            <a href="https://buy.stripe.com/seo500" target="_blank" rel="noopener noreferrer" className="btn-primary text-base px-7 py-3.5 inline-flex">
