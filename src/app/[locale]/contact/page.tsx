...
export default function ContactPage() {
  ...
  function handleSubmit(e: FormEvent) {
    ...
    const msg = encodeURIComponent(
      `Hi, my name is ${form.nombre}. Company: ${form.empresa || "N/A"}. Email: ${form.email}. Goal: ${form.objetivo}.`
    );
        ...
        <div className="relative z-10 w-full max-w-xl">
            ...
            {sent ? (
              ...
              <form onSubmit={handleSubmit} className="card p-7 flex flex-col gap-5">
                {[
                  ...
                  { name: "whatsapp", label: t.fields.whatsapp, type: "tel", placeholder: "+1 234 567 890", required: false },
                ].map((f) => (
                  <div key={f.name}>
          ...
          <AnimateIn delay={200}>
            <div className="mt-6 flex justify-center gap-6">
              ...
              >
                <MessageCircle size={15} /> {t.whatsapp_label}
              </a>
              <a
